...
function snapshotBodyLines(snapshotText) {
...
function parseQuotedElementLine(line, lineNumber, raw) {
...
function stripBareDecorators(content) {
  const match = content.match(
...
function parseBareElementLine(line, lineNumber, raw) {
...
function parseAccessibilityElementLine(raw, lineNumber) {
